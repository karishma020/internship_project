...
//       {/* Content — pt clears the fixed navbar (h-16 mobile / h-20 desktop) */}
//       <div className="relative z-10 flex flex-col flex-1 justify-end px-6 md:px-16 pb-20 md:pb-28 pt-16 md:pt-20 max-w-7xl mx-auto w-full">
//         {/* Label */}
//         <div className={`section-label text-cream/50 mb-6 transition-all duration-1000 delay-300 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
//           Single-origin specialty coffee
//         </div>
...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden bg-espresso">
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col flex-1 justify-end px-6 md:px-16 pb-20 md:pb-28 pt-20 md:pt-24 max-w-7xl mx-auto w-full">
        {/* Label — mt-6 pushes it further below the navbar */}
        <div className={`section-label text-cream/50 mb-6 mt-6 transition-all duration-1000 delay-300 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          Single-origin specialty coffee
        </div>
