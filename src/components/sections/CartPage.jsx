...
import { X, Minus, Plus, ArrowLeft, CheckCircle } from 'lucide-react'
  ...
  return (
    <div className="bg-white border border-parchment p-8 sticky top-8">
      ...
      <div className="space-y-3 mb-6 font-body text-sm text-caramel">
        ...
        {codFee > 0 && (
          <div className="flex justify-between text-caramel/60">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between mb-1">
                  ...
                  <button
                    ...
                    className="text-caramel/30 hover:text-espresso transition-colors ml-3"
                  >
                    <X size={16} />
                  </button>
                </div>
...
function ShippingStep({ onNext, onBack, shippingData, setShippingData }) {
  ...
  const fields = [
    ...
    { id: 'email', label: 'Email Address', placeholder: 'arjun@email.com', type: 'email', half: false },
              ...
              <button
                ...
                className={`flex flex-col items-center gap-2 p-5 border transition-all duration-200 ${
                  method === m.id
                    ...
                    : 'border-parchment hover:border-caramel/40'
                }`}
              >
