...
// //           {/* Logo */}
// //           <a href="#" className="font-display text-2xl text-espresso tracking-wide">Kōhi</a>

// //           {/* Desktop links */}
// //           <ul className="hidden md:flex items-center gap-8">
// //             {links.map(l => (
// //               <li key={l.href}>
// //                 <a href={l.href} className="font-body text-xs tracking-widest2 uppercase text-caramel hover:text-espresso transition-colors duration-200">
// //                   {l.label}
// //                 </a>
// //               </li>
// //             ))}
...
// //             <button
// //               onClick={onCartOpen}
// //               className="relative flex items-center gap-2 text-xs tracking-widest2 uppercase font-light px-4 py-2.5 text-espresso hover:text-caramel transition-colors"
// //               aria-label="Open cart"
// //             >
// //               <ShoppingCart size={18} strokeWidth={1.5} />
// //               <span>Cart</span>
// //               {totalItems > 0 && (
// //                 <span className="absolute -top-1 -right-1 w-5 h-5 bg-espresso text-cream text-[10px] font-mono rounded-full flex items-center justify-center">
// //                   {totalItems}
// //                 </span>
// //               )}
// //             </button>
...
// //                 {/* Avatar */}
// //                 <div className="flex items-center gap-2 px-3 py-1.5 border border-parchment">
// //                   {user.photoURL ? (
// //                     <img src={user.photoURL} alt="avatar" className="w-5 h-5 rounded-full object-cover" />
// //                   ) : (
// //                     <User size={14} className="text-caramel" />
// //                   )}
// //                   <span className="font-mono text-xs text-espresso truncate max-w-[100px]">
// //                     {user.displayName?.split(' ')[0] || user.email?.split('@')[0]}
// //                   </span>
// //                 </div>
// //                 <button
// //                   onClick={logout}
// //                   className="flex items-center gap-1.5 text-xs tracking-widest2 uppercase font-light px-4 py-2.5 border border-espresso text-espresso hover:bg-espresso hover:text-cream transition-all duration-300"
// //                 >
// //                   <LogOut size={13} />
// //                   Logout
// //                 </button>
...
// //               {totalItems > 0 && (
// //                 <span className="absolute -top-1.5 -right-1.5 w-4 h-4 bg-espresso text-cream text-[9px] font-mono rounded-full flex items-center justify-center">
// //                   {totalItems}
// //                 </span>
// //               )}
// //             </button>
// //             <button className="text-espresso" onClick={() => setMenuOpen(!menuOpen)}>
...
// //                 className="flex items-center gap-2 font-body text-sm text-caramel hover:text-espresso transition-colors">
// //                 <LogOut size={14} /> Sign Out
// //               </button>
// //             ) : (
// //               <button onClick={() => { setShowAuth(true); setMenuOpen(false) }} className="btn-primary text-center mt-2">
// //                 Sign In
// //               </button>
// //             )}
// //           </div>
...
// Kōhi circular seal logo — swap size prop to control nav size
    ...
    <>
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        ...
        <nav className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between h-16 md:h-20">
          ...
          {/* Logo — SVG seal, slightly smaller on mobile */}
          <a href="#" aria-label="Kōhi home" className="flex items-center">
